...
export default function QualityProcess() {
  return (
    <>
      <div className="flex flex-row max-w-[80%] mx-auto justify-center my-24 items-center xlN:max-w-[90%] lgN:block">
        <div className="max-w-[750px] mr-16 lgN:max-w-full mdN:mr-0">
          <h2 className="tracking-wide">Quality through Process</h2>

          <h6 className="my-3 tracking-wider">
            Ensuring Excellence with Meticulous Process Quality
          </h6>

          <div className="h-1 w-[150px] bg-black mb-4" />

          <p className="text-justify leading-9 max-w-[600px] lgN:max-w-full lgN:mb-10">
        ...
        <div className="">
          <div className="flex flex-row gap-8 mb-5">
            <div className="w-[175px] h-[120px] rounded-br-[20%] rounded-tl-[20%] border border-neutral-500 justify-center mx-auto flex items-center lgN:w-full lgN:rounded-br-[15%] lgN:rounded-tl-[15%]">
              <div className="">
