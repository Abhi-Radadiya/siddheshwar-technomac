            ...
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                  Your feedback is invaluable to us. Whether you have inquiries
                  about our products, seek collaboration opportunities, or
                  simply want to share your thoughts, our dedicated team is here
                  to assist you.
                </p>
                <ul className="mb-6 md:mb-0">
                  ...
                  <li className="flex">
                    ...
                    <div className="ml-4 mb-4">
                      ...
                      <p className="text-gray-600 dark:text-slate-400">
                        Mobile: +91 81400 38097
                      </p>
                      <p className="text-gray-600 dark:text-slate-400">
                        Mail: info@siddheshwartechnoforge.com
                      </p>
                    </div>
                  </li>
                  <li className="flex">
